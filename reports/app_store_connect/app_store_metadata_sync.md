...
| url_metadata_synced | pass | synced=['privacyPolicyUrl', 'marketingUrl', 'supportUrl'] |

## Actions

| target | status | detail |
| --- | --- | --- |
| appInfoLocalization | updated | name,privacyPolicyUrl,subtitle |
...
| appStoreVersionLocalization.marketingUrl | updated | marketingUrl |
| appStoreVersionLocalization.supportUrl | updated | supportUrl |
