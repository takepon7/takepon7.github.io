...
| daily_plan_has_required_new_entries | pass | 1 planned entries, expected at least 1 |
...
```bash
GITAI_PAIRS_PATH=reports/phase2/seed_score_promotion_smoke/merged_pairs.json \
GITAI_SEED_SCORES_PATH=reports/phase2/seed_score_promotion_smoke/merged_seed_scores.json \
GITAI_DAILY_PUZZLES_PATH=reports/phase2/daily_puzzle_plan_smoke_repeat/merged_daily_puzzles.json \
GITAI_SEED_GHOSTS=reports/phase4/planned_seed_ghosts_smoke.json \
