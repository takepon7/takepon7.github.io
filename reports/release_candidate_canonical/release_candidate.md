...
```bash
GITAI_PAIRS_PATH=data/scoring/pairs.json \
GITAI_SEED_SCORES_PATH=data/scoring/seed_scores.json \
GITAI_DAILY_PUZZLES_PATH=data/puzzle/daily_puzzles.json \
GITAI_SEED_GHOSTS=data/competition/seed_ghosts.json \
